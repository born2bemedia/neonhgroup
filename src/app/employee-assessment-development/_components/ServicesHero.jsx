    ...
    <section className="services-hero">
        <div className="services-hero__container _container">
            <div className="services-hero__body">
                ...
                <p className="services-hero__text">Evaluate Talent. Develop Potential. Drive Performance.</p>
                <Link href="#" className="services-hero__link">Book a Consultation</Link>
            </div>
        </div>
        <div className="services-hero__image"><img src="/images/services/img-05.jpg" alt="image" /></div>
    </section>
  );
};
