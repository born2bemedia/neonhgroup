            ...
            <div className="services-need__container _container">
                <div className="services-need__body">
                    <div className="services-need__col-01">
                        ...
                        <p className="services-need__text">Our HR specialists are ready to assist. Get a personalized consultation to optimize employee assessment and development for your business</p>
                        <Link href="#" className="services-need__link">Contact Us</Link>
                    </div>
                    <div className="services-need__col-02"><img src="/images/services/img-06.png" alt="image" /></div>
                </div>
            </div>
        </section>
    );
