    ...
    <section className="home-impact">
      <div className="home-impact__container _container">
        <div className="home-impact__body">
          <h2 className="home-impact__title">Neon HR Group <br /> Impact in Numbers</h2>
          <p className="home-impact__text">Scalable HR solutions to meet every workforce challenge.</p>
          <Link href="#" className="home-impact__link">Explore Our Expertise</Link>
          <div className="home-impact__items">
            <div className="home-impact__item">
