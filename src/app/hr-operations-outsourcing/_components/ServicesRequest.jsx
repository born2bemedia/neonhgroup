            ...
            <div className="services-request__container _container">
                <div className="services-request__body">
                    ...
                    <motion.p
                        ...
                        variants={fadeInUp}
                        custom={0.3}
                        className="services-request__text">Get a detailed breakdown of our HR Operations & Outsourcing services and choose the best solution for your business.</motion.p>
