                    ...
                    <nav className="header__mobile-nav">
                        <ul className="header__mobile-list">
                            <li className="header__mobile-item _submenu">
                                ...
                                <ul
                                    className={`header__mobile-submenu${isSubmenuOpen ? "_active" : ""}`}
                                >
                    ...
                    <div className="header__mobile-bottom">
                        ...
                        <ul className="header__mobile-socials">
                            <li className="header__mobile-social">
                                <Link
                                    href="#"
                                    className="header__mobile-social-link _facebook"
                                >
                                    <svg
                                        width="18"
                                        height="17"
                                    ...
                                    >
                                        <path
                                            d="M16.0837 8.50002C16.0837 4.59002 12.9103 1.41669 9.00033 1.41669C5.09033 1.41669 1.91699 4.59002 1.91699 8.50002C1.91699 11.9284 4.35366 14.7829 7.58366 15.4417V10.625H6.16699V8.50002H7.58366V6.72919C7.58366 5.3621 8.69574 4.25002 10.0628 4.25002H11.8337V6.37502H10.417C10.0274 6.37502 9.70866 6.69377 9.70866 7.08335V8.50002H11.8337V10.625H9.70866V15.5479C13.2857 15.1938 16.0837 12.1763 16.0837 8.50002Z"
                                            fill="#020513"
                                        />
                                    </svg>
                                </Link>
                            ...
                            <li className="header__mobile-social">
                                <Link
                                    href="#"
                                    className="header__mobile-social-link _instagram"
                                >
                                    <svg
                                        width="18"
                                        height="17"
                            ...
                            <li className="header__mobile-social">
                                <Link
                                    href="#"
                                    className="header__mobile-social-link _linkedin"
                                >
                                    <svg
                                        width="18"
                                        height="17"
